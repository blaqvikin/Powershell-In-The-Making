...
foreach ($Lang in $UserMap.Values) {
    ...
    # Adaptive check: Use Lip-Language-Pack for Vietnamese, Client-Language-Pack for others
...
Write-Host "--- Configuration Completed ---" -ForegroundColor Black -BackgroundColor Green
Write-Host "Upload the Vietnamese LIP pack to Azure, run the script, and execute a fresh restart."
